...
# 🎓 Victória Toniato Salviato

### 💻 Systems Developer & Analyst &nbsp;|&nbsp; 📊 Passionate About Data
...
> ⚠️ **Note:** the stats cards above are generated by a free, community-run service (`github-readme-stats.vercel.app`). It occasionally returns a broken image due to traffic limits on its hobby-tier hosting — this isn't an error in your README. If it keeps failing, the most reliable fix is to [deploy your own free instance on Vercel](https://github.com/anuraghazra/github-readme-stats#deploy-on-vercel) (one click, takes ~2 minutes) and swap the URL above for your own.
